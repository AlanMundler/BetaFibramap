...
import DisqusCommentsPersonal from "../../../components/Disqus/DisqusCommentsPersonal";
import Link from "next/link";

function ReviewPersonalPage() {
  return (
    <section className="relative overflow-x-auto h-full sm:ml-64 sm:mr-36">
      ...
      <div className=" ml-4 mr-4 px-3 py-4  bg-gray-50 dark:bg-gray-800">
        <p className=" mb-4 text-l font-semibold dark:text-white">
          En esta seccion los comentarios van dirigidos hacia servicio de fibra optica de Personal.
        </p>
        <p className=" mb-4 text-l font-semibold dark:text-white">
        ...
        <DisqusCommentsPersonal />
      </div>
    </section>
  );
}

export default ReviewPersonalPage;
